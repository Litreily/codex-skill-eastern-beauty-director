...
当前版本先聚焦在古风与东方幻想，会把「古风美女」「国风人物」「仙侠女主」「敦煌飞天」「龙女」「浴后美人」这类简单需求，扩写成更有导演感、更适合 Midjourney、Stable Diffusion、ComfyUI、DALL-E、GPT image、Seedream 等工具使用的提示词。
...
- `references/`：路线库、提示词框架、角色系统、质量控制规则。
